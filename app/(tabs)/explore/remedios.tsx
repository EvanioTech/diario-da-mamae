...
export default function RemediosPage() {
  ...
  const fetchFeedings = async () => {
    try {
      ...
      const Remedios = eventos.filter((e: Evento) =>
        ['Remédios', 'Vitaminas', 'Suplementos', 'Homeopatia'].includes(e.key_evento)
      );
      setFeedings(Remedios);
    } catch (e) {
      console.error('Erro ao buscar Remédios:', e);
    }
  };
